...
def parse_args():
    ...
    parser.add_argument('--normalize', action='store_true',
                        help='Normalize the AFM images', default=False)
    parser.add_argument('--image-split', nargs='+', type=int, default=None,
                        help='The image split for the AFM images')
    parser.add_argument('--threshold', type=float, default=0.5,
                        help='The threshold for the AFM images')
...
def main(args):
    ...
    if args.detect_only or not args.match_only:
        ...
        elif args.output_format == 'cif':
            io.write(out_path / f"{path.stem}_water.cif", amorphous_part)
    ...
    if args.match_only or not args.detect_only:
        ...
        if args.output_format == 'xyz':
            ...
            io.write(out_path / f"{path.stem}_combine.cif", results)
